...
function forms(formSelector, modalTimerId) {
  ...
  function bindPostData(form) {
    form.addEventListener('submit', function (e) {
      e.preventDefault();
      var statusMessage = document.createElement('img'); //spinner

      statusMessage.src = message.loading;
      statusMessage.style.cssText = "\n                display: block;\n                margin: 0 auto;\n            ";
      statusMessage.textContent = message.loading;
      form.insertAdjacentElement('afterend', statusMessage);
      var formData = new FormData(form); //Серевер принимает информацию либо в формате FormData либо JSON
  ...
  (0,_services_services__WEBPACK_IMPORTED_MODULE_5__.getResource)("http://localhost:3000/menu").then(function (data) {
    data.forEach(function (_ref) {
      ...
      var element = document.createElement("div"),
          priceNew = price * 85;
      element.classList.add("menu__item");
      element.innerHTML = "\n                    <img src=\"".concat(img, "\" alt=\"").concat(altimg, "\">\n                    <h3 class=\"menu__item-subtitle\">").concat(title, "</h3>\n                    <div class=\"menu__item-descr\">").concat(descr, "</div>\n                    <div class=\"menu__item-divider\"></div>\n                    <div class=\"menu__item-price\">\n                        <div class=\"menu__item-cost\">\u0426\u0435\u043D\u0430:</div>\n                        <div class=\"menu__item-total\"><span>").concat(priceNew, "</span> \u0440\u0443\u0431/\u0434\u0435\u043D\u044C</div>\n                    </div>\n                ");
...
function slider(_ref) {
  ...
  var slideInd = 1;
  var offset = 0;
  current.textContent = "0".concat(slideInd);
  ...
  function addZero(num) {
    if (slides.length < 10) {
      current.textContent = "0".concat(num);
    } else {
      current.textContent = "".concat(num);
    }
  }
...
window.addEventListener('DOMContentLoaded', function () {
  var modalTimerId = setTimeout(function () {
    return openModal('.modal', modalTimerId);
  }, 50000);
